...
public class DatePickerFragmentHomes
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Covoituragee.DatePickerFragmentHomes, Covoituragee", DatePickerFragmentHomes.class, __md_methods);
	}


	public DatePickerFragmentHomes ()
	{
		super ();
		if (getClass () == DatePickerFragmentHomes.class) {
			mono.android.TypeManager.Activate ("Covoituragee.DatePickerFragmentHomes, Covoituragee", "", this, new java.lang.Object[] {  });
		}
	}
