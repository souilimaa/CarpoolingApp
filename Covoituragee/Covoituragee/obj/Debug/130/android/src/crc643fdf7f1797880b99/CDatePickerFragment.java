...
public class CDatePickerFragment
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Covoituragee.CDatePickerFragment, Covoituragee", CDatePickerFragment.class, __md_methods);
	}


	public CDatePickerFragment ()
	{
		super ();
		if (getClass () == CDatePickerFragment.class) {
			mono.android.TypeManager.Activate ("Covoituragee.CDatePickerFragment, Covoituragee", "", this, new java.lang.Object[] {  });
		}
	}
