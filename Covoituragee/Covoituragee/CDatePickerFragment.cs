...
{
    public class CDatePickerFragment : DialogFragment, DatePickerDialog.IOnDateSetListener
    {
        ...
        public void OnDateSet(DatePicker view, int year, int month, int dayOfMonth)
        {
            ...
            else
            {
                ...
                Button cdatePickerButton = Activity.FindViewById<Button>(Resource.Id.cdatePickerButton);
                cdatePickerButton.Text = selectedDate.ToString("yyyy-MM-dd");
            }
        }
